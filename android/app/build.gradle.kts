...
// Release signing lives in android/key.properties + android/app/*.jks — both
// gitignored. Machines without them (CI, other devs) fall back to debug keys.
...
android {
    namespace = "kr.co.monolith.spot_link"
    ...
    defaultConfig {
        ...
        applicationId = "kr.co.monolith.spot_link"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        // BLE advertise/scan + mobile_scanner require API 23+ (we use 24 for stability).
